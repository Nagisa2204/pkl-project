...
return [
    ...
    'attributes'             => [
        ...
        'customer'                 => 'pelanggan',
        'buyer_name'               => 'nama penerima',
        'buyer_whatsapp'           => 'nomor WhatsApp penerima',
        'shipping_address_id'      => 'alamat pengiriman',
        'shipping_service'         => 'layanan pengiriman',
        'shipment_status'          => 'status pengiriman',
        'shipping_origin_id'       => 'alamat pickup toko',
        'selected_province_id'     => 'provinsi',
        'selected_city_id'         => 'kota/kabupaten',
        'selected_district_id'     => 'kecamatan',
        'selected_subdistrict_id'  => 'kelurahan/desa',
        'courier'                  => 'kurir',
        'date'                     => 'tanggal',
